...
#define VIA1_TIMER1_CL      (VIA1_ADDRESS + 0x04)
#define VIA1_TIMER1_CH      (VIA1_ADDRESS + 0x05)
#define VIA1_TIMER1_LL      (VIA1_ADDRESS + 0x06)
#define VIA1_TIMER1_LH      (VIA1_ADDRESS + 0x07)
